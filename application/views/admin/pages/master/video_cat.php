              ...
              <?php $c = 1; foreach($categories as $category){
	      				if($category['p_id'] == 0){
	      					if($category['category_name'] != ''){
	      						echo '<tr><td>'.$c.'</td><td class="v_cat_list_item" data-vc_id="'.$category['v_id'].'">'.$category['category_name'].'</td><td><a href="javascript:void(0);" class="btn btn-info btn-flat video_cat_delte" data-vid="'.$category['v_id'].'"><i class="fa fa-trash"></i></a></td></tr>';
	      					}
	      				}
						else{
