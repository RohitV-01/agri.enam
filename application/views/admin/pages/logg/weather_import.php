...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1 class="pull-left">Weather Data Import</h1>
	</section>
	<!-- Main content -->
			...
			<section class="col-lg-12 connectedSortable">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Import Excel Data of Weather forecast</h3>
					...
					<form name="video_form" id="import_form" role="form" class="form-horizontal" method="POST">
                		...
                		<div class="box-footer">
        					...
        					<button type="reset" class="btn btn-default pull-right btn-space">Cancel</button>
                                                <a href="<?php echo base_url(); ?>docs/Weather_Forecast.xlsx" style="margin-right:10px;" class="btn btn-primary pull-right">Sample Data</a>
        				</div>	
					</form>
					<br />
...
<script type="text/javascript">
	...
	$.ajax({
		method:"POST",
		url:"<?php echo base_url(); ?>admin/Excel_import/weather_forecast_import",
		dataType:'json',
		data:formdata,
                beforeSend: function(){
