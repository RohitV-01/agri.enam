		...
		<div class="box box-primary">
			...
			<?php if($group != 'subadmin'){ ?>
				<div class="form-group">
					<label class="col-sm-3 control-label">Image (1275 x 449)</label>
					<div class="col-sm-9">
						...
						<tbody>
							...
							foreach($sliders as $slider){?>
								...
								<tr class="<?php if(!$find){ echo "find"; } ?>">
									...
									<td>
									<?php if($group == 'subadmin'){ ?>
										<a title="Edit" href="javascript:void(0);" class="btn btn-info btn-flat slider_tranlate" data-slider_id="<?php echo $slider['s_id'];?>"><i class="fa fa-edit"></i></a>
									<?php } else { ?>
						...
						<tbody>
							...
							foreach($sliders as $slider){?>
								...
								<tr>
									...
									<?php }?>
									<td>
										<a title="Edit" href="javascript:void(0);" class="slider_edit" data-slider_id="<?php echo $slider['s_id'];?>"><i class="fa fa-edit"></i></a>
										<?php if($group != 'subadmin') { ?>
