...
<ul class="nav navbar-nav menu-section1" <?php if(!isset($_SESSION['user_id'])){?>style="display: none;" <?php } ?>>
	...
	<li class="dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li><a title="Video Catagory" href="<?php echo base_url(); ?>admin/admin/commodity_category"><i class="fa fa-video-camera"></i>Commodity category</a></li>
				<?php }?>				
			</ul>
	</li>
	<?php } ?>
	...
	<li class="dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li><a title="Commodity" href="<?php echo base_url(); ?>admin/admin/commodity-add"><i class="fa fa-delicious" aria-hidden="true"></i> Commodity add</a></li>
				<li><a title="Commodity" href="<?php echo base_url(); ?>admin/admin/commodity"><i class="fa fa-delicious" aria-hidden="true"></i> Commodity parameter</a></li>
...
<li><a title="Success Stories" href="<?php echo base_url(); ?>admin/admin/trade_data"><i class="fa fa-delicious" aria-hidden="true"></i> Trade Data </a></li>
<li><a title="Heading" href="<?php echo base_url(); ?>admin/admin/heading"><i class="fa fa-delicious" aria-hidden="true"></i> Headings </a></li>
<li><a title="Blogs" href="<?php echo base_url(); ?>admin/admin/enam_blogs"><i class="fa fa-delicious" aria-hidden="true"></i> Enam Blog </a></li>
<li><a title="Pop up" href="<?php echo base_url(); ?>admin/admin/pop_up"><i class="fa fa-delicious" aria-hidden="true"></i> Pop up </a></li>
			</ul>
	</li>
	<li class="dropdown">
	...
	<?php if($this->ion_auth->is_admin()){ ?>
			<li>
				<a title="Cache Files" href="<?php echo base_url();?>admin/Logg_ctrl"> <i class="fa fa-files-o"></i> Logg Report</a>
			</li>		
			<li>
				<a title="Cache Files" href="<?php echo base_url();?>admin/Excel_import"> <i class="fa fa-files-o"></i> Contact Detail Import</a>
			</li>
			<li>
				<a title="Cache Files" href="<?php echo base_url();?>admin/Excel_import/unified_licencce"> <i class="fa fa-files-o"></i> Unified Licence Import</a>
			</li>
			<li>
				<a title="Cache Files" href="<?php echo base_url();?>admin/Excel_import/stackholder"><i class="fa fa-files-o"></i>Stackholder Import</a>
			</li>
			<li>
				<a title="Cache Files" href="<?php echo base_url();?>admin/File_upload_ctrl"> <i class="fa fa-files-o"></i>File Upload</a>
			</li>	
			<li>
				<a title="Cache Files" href="<?php echo base_url();?>admin/admin/backup"> <i class="fa fa-files-o"></i> Database Backup</a>
			</li>	
			<li>
				<a title="Cache Files" href="<?php echo base_url();?>admin/Excel_import/weather_forecast"> <i class="fa fa-files-o"></i> Weather forecast upload</a>
			</li>	
