...
<div class="container-fuild content-section" style="padding-top:10px;float:left;width:100%;padding-bottom:15px;">
	<div class="container">
		<div class="col-md-12 bc-nav"><a href="<?php echo base_url(); ?>" title=""><?php echo $this->lang_file->heading_fetch('home'); ?></a>&nbsp; <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>&nbsp; <a href="<?php echo base_url(); ?>eNam-mandi-status"><?php echo $this->lang_file->heading_fetch('enam_mandis'); ?></a>&nbsp; <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>&nbsp; <?php echo $this->lang_file->heading_fetch('enam_mandis'); ?>
		</div>
		<div class="col-sm-9 content-9 h-space-padd-r">
			...
			<div class="col-md-2 well text-center no-of-mandis-box" id="contact_page_mandi_count"><?php echo $this->lang_file->heading_fetch('mandi_no_of_enam_mandis'); ?><br />
				<b><span id="contact_page_mandi_count_span" style="color:#000;font-size:18px;"><?php echo $mandi_count;?></span></b>
			</div>
...
<script>
	...
	function getCsrfToken() {
		return {
			[csrfName]: csrfHash // Use the variables set in the view
		};
	}
</script>
		...
		$.ajax({
			...
			success: function(response) {
				...
				if (response.status == 200) {
					...
					$('#contact_page_mandi_count_span').html(<?php echo $mandi_count;?>);
				}
			}
		});
	}
