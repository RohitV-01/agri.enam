...
<section class="title-header-bg">
	<div class="text-center">
		<h3><?php echo $this->lang_file->heading_fetch('head_page_emandi') ?></h3>
        <div style="margin-top:12px;" class="text-center"><a href="<?php echo base_url(); ?>" title=""><img style="margin-top:-6px;" alt="" src="<?php echo base_url(); ?>/assest/images/home-ico.png"></a> <span id="bredcrum"> / <?php echo $this->lang_file->heading_fetch('head_page_emandi') ?> </span></div>
...
<section class="content-section o-content-sec emandi-sec">
	...
	<div class="row">
		...
		<div class="col-md-12 emandi-list mandi-table table-responsive">
			<table class="table table-striped table-bordered">
				<thead><tr><th>STATE</th><th>DISTRICT</th><th>MANDIS</th><th style="width:28%;">ADDRESS</th><th>CONTACT NO.</th><th>MANDI COMMODITY</th></tr></thead>
			</table>
						...
						'<div class="panel-heading" role="tab" id="headingOne">'+
      							'<table>'+
          							'<tr role="tab" id="headingOne">'+
										...
										'<td style="width:28%;">'+ value.address +'</td>'+
										'<td>'+ value.contact  +'</td>'+
