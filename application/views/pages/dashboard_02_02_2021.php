...
<!-- <style type="text/css">
	.TickerBox table tbody tr td:first-child 
	{
     background-color: transparent;
    }
</style>

 <div style="margin-top:-15px;padding:0 16px;margin-bottom: 5px;" id='include-from-outside'></div>
    <script type='text/javascript'>
      $('#include-from-outside').load('https://agmarknet.gov.in/agnew/namticker.aspx');
   </script> 
    -->
...
<div class="col-sm-3 video-sec wow fadeInLeft" data-wow-delay="0.5s" >
			<div class="sidebar-header-title">
				<span class="e-text"><?php echo $this->lang_file->heading_fetch('enam');?> <?php echo $this->lang_file->heading_fetch('elearningvideos');?></span>
			</div>
			<div class="row">
