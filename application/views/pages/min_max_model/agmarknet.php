...
<div class="col-md-2 emandi-select e-trade-inputs1"><b><?php echo $this->lang_file->heading_fetch('min_max_from_date');?></b> <input class="form-control" type="date" id="min_max_apmc_from_date" name="min_max_apmc_from_date" max="<?php echo date('Y-m-d', strtotime('2021-01-29'));?>"/></div>


<div style="padding-left:15px;" class="col-md-2 emandi-select e-trade-inputs1"><b><?php echo $this->lang_file->heading_fetch('min_max_to_date');?></b> <input class="form-control" type="date" id="min_max_apmc_to_date" name="min_max_apmc_to_date" max="<?php echo date('Y-m-d', strtotime('2021-01-29'));?>"/></div>
	...
	for(var i = parseInt(parseInt(start*limit)+slug); i <= (parseInt(parseInt(parseInt(start)*10))+10); i++){
		...
		if(i < array_length){
			...
			x = x + '<tr>'+
					...
					'<td align="center" style="text-align:center;">'+ data_array[i].District +'</td>'+
					'<td align="center" style="text-align:center;">'+ data_array[i].mandi +'</td>'+
					'<td align="center" style="text-align:center;">'+ Non_mandi +'</td>'+
					'<td align="center" style="text-align:center;">'+ data_array[i].Commodity +'</td>'+
					'<td align="center" style="text-align:center;">'+ data_array[i].arrival_qty +'</td>'+
					'<td align="center" style="text-align:center;">'+ data_array[i].variety  +'</td>'+
					'<td align="center" style="text-align:center;">'+ number_formate(data_array[i].minrate) +'</td>'+
					'<td align="center" style="text-align:center;">'+ number_formate(data_array[i].maxrate) +'</td>'+
					'<td align="center" style="text-align:center;">'+ number_formate(data_array[i].modelprice) +'</td>'+
					'<td align="center" style="text-align:center;">0</td>'+
					'<td align="center" style="text-align:center;">'+ data_array[i].Unit +'</td>'+
					'<td align="center" style="text-align:center;">'+ formatDate(data_array[i].trn_date) +'</td>';
				x = x + '</tr>';  
		}
		else{
    		break;
