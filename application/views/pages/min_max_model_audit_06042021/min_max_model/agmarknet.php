...
<div class="col-md-2 emandi-select e-trade-inputs1"><b><?php echo $this->lang_file->heading_fetch('min_max_from_date');?></b> <input class="form-control" type="date" id="min_max_apmc_from_date" name="min_max_apmc_from_date" min="<?php echo date('Y-m-d', strtotime($date .' -7 day'));?>" max="<?php echo date('Y-m-d', strtotime($date .' -1 day'));?>"/></div>


<div style="padding-left:15px;" class="col-md-2 emandi-select e-trade-inputs1"><b><?php echo $this->lang_file->heading_fetch('min_max_to_date');?></b> <input class="form-control" type="date" id="min_max_apmc_to_date" name="min_max_apmc_to_date" min="<?php echo date('Y-m-d', strtotime($date .' -7 day'));?>" max="<?php echo $date;?>"/></div>
	...
	for(var i = parseInt(parseInt(start*limit)+slug); i <= (parseInt(parseInt(parseInt(start)*10))+10); i++){
		...
		if(i < array_length){
			...
			x = x + '<tr>'+
					...
					'<td align="center" style="text-align:center;">'+ data_array[i].Agma_unit +'</td>'+
