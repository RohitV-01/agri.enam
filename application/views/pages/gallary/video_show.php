...
<div class="container">
	<div class="col-md-12 bc-nav"><a href="<?php echo base_url(); ?>" title="">Home</a>&nbsp;<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>&nbsp;<a href="<?php echo base_url(); ?>elearning">eLearning videos</a>&nbsp;<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>&nbsp;
	<?php if($this->uri->segment(2) == ''){	 ?>
		all videos
	<?php } else {
				if(urldecode($this->uri->segment(2)) == 'Others Video'){ ?>
					<span><?php echo ucwords(urldecode($this->uri->segment(2)));?> </span>
	<?php } else{ ?>
				<span><?php echo ucwords(urldecode($this->uri->segment(2)));?></span>
		  <?php } } ?>
	</div>
			...
			<?php if(isset($videos) && count($videos)>0){?>
				<?php $c = 1; foreach($videos as $video){ ?>						
					<div class="row elearn-v-box" style="margin-bottom:1px;">
						...
						<div class="col-md-6 video-g-details side-video-list" style="padding-left:8px;" >
<h5><b><a href="<?php echo base_url();?>elearning/id/<?php echo $video['video_id'];?>"><?php echo $video['v_title']; ?></a></b></h5>
