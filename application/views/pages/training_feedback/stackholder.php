...
<div class="col-md-4 bc-nav" ><a href="<?php echo base_url(); ?>" title=""><?php echo $this->lang_file->heading_fetch('home'); ?></a>&nbsp;<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>&nbsp; <?php echo $this->lang_file->heading_fetch('training_feedback'); ?>&nbsp;<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>&nbsp; <?php echo $this->lang_file->heading_fetch('train_stackholder'); ?>
	<?php if(!empty($msg)){ ?>
	...
	<div class="col-md-12">
		<div class="col-md-6">
				<div class="col-md-12" align="center">
					<input type="hidden" name="feed_options" onclick="show1()" value="SH">
				</div>
				...
				<div class="col-md-6" id="round1">
					...
					<select class="form-control" id="feed_round" name="feed_round" required>
						...
						<option id="R1" value="1">Round 1</option>
						<option id="R2" value="2">Round 2</option>
						<option id="R3" value="3">Round 3</option>
						<option id="R4" value="4">Round 4</option>
					</select>					
				</div>
