	...
	<div class="col-md-12">
		<div class="col-md-6">
				<div class="col-md-12" align="center">
					<input type="hidden" name="feed_options" value="MS">
				</div>
				...
				<div class="col-md-6" id="round1">
					<strong id="round_name">  <?php echo $this->lang_file->heading_fetch('feed_quarter'); ?>  *</strong>
					<strong id="quarter_name" style="display:none">  Quarter  *</strong>
					<select class="form-control" id="feed_round" name="feed_round" required>
						<option id="Q0" value="">-- Select Quarter --</option>
						<option id="Q1" value="1">Quarter 1</option>
						<option id="Q2" value="2">Quarter 2</option>
						<option id="Q3" value="3">Quarter 3</option>
						<option id="Q4" value="4">Quarter 4</option>
					</select>					
				</div>
...
<!-- 				<div class="col-md-12" id="village">
            ...
            <option id="SE" value="SE">Secretary</option>
            <option id="MI" value="MI">Mandi Inspector</option>
            <option id="DE" value="DE">DEO</option>
            <option id="AS" value="AS">Assayer</option>
            <option id="WE" value="WE">Weighment</option>
            <option id="OS" value="OS">Other Staff</option>
					</select>				
				</div>
<!-- 
