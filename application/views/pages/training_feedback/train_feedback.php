	...
	<div class="col-md-12">
		<div class="col-md-6">
				<div class="col-md-12" align="center">
					<label class="radio-inline"><input type="radio" name="feed_options" onclick="show1()" checked value="SH">Stake holder</label>
					<label class="radio-inline"><input type="radio" name="feed_options" onclick="show2()" value="MS">Mandi Staff</label>
				</div>
				...
				<div class="col-md-6" id="round1">
					<strong id="round_name">  <?php echo $this->lang_file->heading_fetch('feed_round'); ?>  *</strong>
					<strong id="quarter_name" style="display:none">  Quarter  *</strong>
					<select class="form-control" id="feed_round" name="feed_round">
						<option id="R0" value="">-- Select Round --</option>
						<option id="R1" value="R1">Round 1</option>
						<option id="R2" value="R2">Round 2</option>
						<option id="R3" value="R3">Round 3</option>
						<option id="R4" value="R4">Round 4</option>
						<option id="Q0" style="display:none;" value="">-- Select Quarter --</option>
						<option id="Q1" style="display:none;" value="Q1">Quarter 1</option>
						<option id="Q2" style="display:none;" value="Q2">Quarter 2</option>
						<option id="Q3" style="display:none;" value="Q3">Quarter 3</option>
						<option id="Q4" style="display:none;" value="Q4">Quarter 4</option>
					</select>					
				</div>

<!-- 				<div class="col-md-6 " id="round2" style="display: none;">
 ...
 -->
				...
				<div class="col-md-12" id="category1">
					<strong> <?php echo $this->lang_file->heading_fetch('feed_user_category'); ?> *</strong>
					<select class="form-control" id="category" name="category">
						<option value="">-Select Category-</option>
						<option id="F" value="F"><?php echo $this->lang_file->heading_fetch('feed_farmer'); ?></option>
            <option id="T" value="T"><?php echo $this->lang_file->heading_fetch('feed_trader'); ?></option>
            <option id="A" value="A"><?php echo $this->lang_file->heading_fetch('feed_com_agent'); ?></option>
            <option id="M" value="M"><?php echo $this->lang_file->heading_fetch('feed_mandi_staff'); ?></option>
            <option id="O" value="O"><?php echo $this->lang_file->heading_fetch('feed_others'); ?></option>
            <option id="SE" style="display:none;" value="SE">Secretary</option>
            <option id="MI" style="display:none;" value="MI">Mandi Inspector</option>
            <option id="DE" style="display:none;" value="DE">DEO</option>
            <option id="AS" style="display:none;" value="AS">Assayer</option>
            <option id="WE" style="display:none;" value="WE">Weighment</option>
            <option id="OS" style="display:none;" value="OS">Other Staff</option>
					</select>				
				</div>
<!-- 
				<div class="col-md-12" id="category2" style="display:none;">
					<strong> <?php //echo $this->lang_file->heading_fetch('feed_user_category'); ?> *</strong>
					<select class="form-control" id="category" name="category">
						<option value="">-Select Category-</option>
						<option value="F">Secretary</option>
            <option value="MI">Mandi Inspector</option>
            <option value="DE">DEO</option>
            <option value="AS">Assayer</option>
            <option value="WE">Weighment</option>
...
$(function() {
        ...
        var val = $(this).val();
        if (val == 'F' || val == 'T' || val == 'A' || val == 'M' || val == 'O' || val == 'SE'|| val == 'MI'|| val == 'DE'|| val == 'AS'|| val == 'WE' || val == 'OS') {
          $('#questions').show();
            load_first();
			function load_first(){
			$.ajax({
					...
					url : 'https://train.enam.gov.in/NamWebSrv/rest/mobile/feedback/getFeedbackQuestionnaire',
					data : {
						'category': val
					},
...
<script type="text/javascript">
function show1(){
	document.getElementById('round_name').style.display = 'block';
  ...
  document.getElementById('R4').style.display = 'block';
	...
	document.getElementById('quarter_name').style.display = 'none';
...
function show2(){
	document.getElementById('round_name').style.display = 'none';
  ...
  document.getElementById('R4').style.display = 'none';
	...
	document.getElementById('quarter_name').style.display = 'block';
