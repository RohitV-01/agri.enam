...
<div class="container-fuild content-section" style="padding-top:15px;float:left;width:100%;padding-bottom:15px;">
	<div class="container">
		<div class="col-md-12 bc-nav" >
			...
			<?php echo $this->lang_file->heading_fetch('pop_warehousing');?></a>

		</div>
		<div class="col-sm-9 content-9 h-space-padd-r">

			<h3 class="p-title"><span><?php echo $this->lang_file->heading_fetch('pop_warehousing');?><p class="t-stake-data"><a id="backBtn"><b><?php echo $this->lang_file->heading_fetch('back');?></b>  <img src="<?php echo base_url(); ?>assest/images/pop/back-arrow.png" style="width: 20px;"></a></p></span></h3>
			<div align="center" class="row">
				<p>&nbsp;</p>

				<div class="col-md-2"><a href="<?php echo base_url(); ?>pop-dashboard/warehousing/providers"><img src="<?php echo base_url();?>/assest/images/pop/ser_provider.png" style="width:118px; height: 118px;" /><br />
