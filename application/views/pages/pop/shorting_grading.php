...
<div class="container-fuild content-section" style="padding-top:15px;float:left;width:100%;padding-bottom:15px;">
	<div class="container">
		<div class="col-md-12 bc-nav" >
			...
			<?php echo $this->lang_file->heading_fetch('sorting_grading');?></a>

		</div>
		<div class="col-sm-9 content-9 h-space-padd-r">

			<h3 class="p-title"><span><?php echo $this->lang_file->heading_fetch('short_grade_providers');?><p class="t-stake-data"><a id="backBtn"><b><?php echo $this->lang_file->heading_fetch('back');?></b>  <img src="<?php echo base_url(); ?>assest/images/pop/back-arrow.png" style="width: 20px;"></a></p></span></h3>
			<div align="center" class="row">
				<p>&nbsp;</p>

				
				<div class="col-md-2" style="padding-top: 32px"><a href="" target=""><img src="<?php echo base_url(); ?>/assest/images/pop/IDS Kisan Network.png" style="width:114px; height: 59px;" /><br/><br>
				...
				<div class="col-md-2" style="padding-top: 7px;"><a href="" target=""><img src="<?php echo base_url(); ?>assest/images/pop/Intello labs.jpg" style="width:133px; height: 103px;"/>
				<p id="intello_p"><b id="intello" style="padding-left: 15px;"><?php echo $this->lang_file->heading_fetch('intello');?></b></a><img class="imgpop" data-id="intello" src="<?php echo base_url();?>assest/images/pop/i_tag.png"/></p>
				</div>
				...
				<div class="col-md-2" style="padding-top: -22px;"><a 
					href="" target=""><img src="<?php echo base_url();?>assest/images/pop/go_green_warehouses.jpg" style="width:131px; height: 93px;"/><br /><br>
