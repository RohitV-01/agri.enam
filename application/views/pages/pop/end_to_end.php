...
<div class="container-fuild content-section" style="padding-top:15px;float:left;width:100%;padding-bottom:15px;">
	<div class="container">
		<div class="col-md-12 bc-nav" >
			...
			<?php echo $this->lang_file->heading_fetch('institutional_buyer');?></a>

		</div>
		<div class="col-sm-9 content-9 h-space-padd-r">

			<h3 class="p-title"><span><?php echo $this->lang_file->heading_fetch('institutional_buyer');?><p class="t-stake-data"><a id="backBtn"><b><?php echo $this->lang_file->heading_fetch('back');?></b>  <img src="<?php echo base_url(); ?>assest/images/pop/back-arrow.png" style="width: 20px;"></a></p></span></h3>
			<div align="center" class="row">
				<p>&nbsp;</p>
				
				<div class="col-md-2" style="padding-top: 49px;"><a href="" ><img src="<?php echo base_url(); ?>assest/images/pop/absolute.png" style="width:94px; height: 49px;" /><br/><br>
				...
				<div class="col-md-2" style="padding-top: 21px;margin-left: 45px;"><a href=""><img src="<?php echo base_url(); ?>assest/images/pop/crofarm.png" style="width:100px; height: 70px;" /><br/><br>
				<p id="pop_crofarm"><b style=""><?php echo $this->lang_file->heading_fetch('pop_crofarm'); ?></b></a><img class="imgpop" data-id="pop_crofarm" src="<?php echo base_url();?>assest/images/pop/i_tag.png"/></p>
				</div>
				<p>&nbsp;</p>
			</div>
