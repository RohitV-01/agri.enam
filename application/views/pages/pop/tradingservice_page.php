...
<div class="container-fuild content-section" style="padding-top:15px;float:left;width:100%;padding-bottom:15px;">
	<div class="container">
		...
		<?php echo $this->lang_file->heading_fetch('trading_platform'); ?></div>
		<div class="col-sm-9 content-9 h-space-padd-r">
			...
			<div align="center" class="row">
				...
				<div class="col-md-2"><a href="<?php echo base_url(); ?>pop-dashboard/trading-platforms/platforms"><img src="<?php echo base_url(); ?>assest/images/pop/platforms_inte.png" style="width:118px; height: 118px;" /><br />
				<b><?php echo $this->lang_file->heading_fetch('platforms_integrated');?></b></a>
				</div>
				<div class="col-md-2"><a href="<?php echo base_url(); ?>advance-demand"><img src="<?php echo base_url(); ?>assest/images/pop/advance_demand.png" style="width:118px; height: 118px;" /><br />
				<b><?php echo $this->lang_file->heading_fetch('advance_demand');?></b></a>
				</div>
				<div class="col-md-2"><a href="<?php echo base_url(); ?>advance-supply"><img src="<?php echo base_url(); ?>assest/images/pop/advance_supply.png" style="width:118px; height: 118px;" /><br />
				<b><?php echo $this->lang_file->heading_fetch('advance_supply');?></b></a>
				</div>
				<div class="col-md-2"><a href="<?php  echo base_url();?>pop-dashboard/trading-platforms/trade-details"><img src="<?php echo base_url(); ?>assest/images/pop/trade_price.png" style="width:118px; height: 118px;" /><br />
				<b><?php echo $this->lang_file->heading_fetch('trade_price');?></b></a>
				</div>
