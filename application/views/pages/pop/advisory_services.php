...
<div class="container-fuild content-section" style="padding-top:15px;float:left;width:100%;padding-bottom:15px;">
	<div class="container">
		<div class="col-md-12 bc-nav">
			...
			<?php echo $this->lang_file->heading_fetch('advisory_services');?></a>

		</div>
		<div class="col-sm-9 content-9 h-space-padd-r">

			<h3 class="p-title"><span><?php echo $this->lang_file->heading_fetch('advisory_services');?><p class="t-stake-data"><a id="backBtn"><b><?php echo $this->lang_file->heading_fetch('back');?></b>  <img src="<?php echo base_url(); ?>assest/images/pop/back-arrow.png" style="width: 20px;"></a></p></span></h3>
			
			<div align="center" class="row">
				<p>&nbsp;</p>

				<div class="col-md-2" style="padding-top: 19px;"><a href="" target=""><img src="<?php echo base_url();?>/assest/images/pop/Apna Gudam.png" style="width:108px; height: 91px;" />
				...
				<div class="col-md-2" style="padding-top: 37px"><a href="" target=""><img src="<?php echo base_url(); ?>/assest/images/pop/IDS Kisan Network.png" style="width:135px; height: 53px;" /><br/><br>
				...
				<div class="col-md-2" style="padding-top: 19px;"><a href="" target=""><img src="<?php echo base_url(); ?>assest/images/pop/FPO Bazaar.png" style="width:100px; height: 70px;" /><br/><br>
				...
				<div class="col-md-2"><a href="" target=""><img src="<?php echo base_url(); ?>assest/images/pop/krishfy_logo.png" style="width:90px; height: 88px;" /><br/><br>
				<p id="krishify" style="text-align: center;"><b id="fpo"><?php echo $this->lang_file->heading_fetch('krishify');?></b></a><img class="imgpop" data-id="krishify" src="<?php echo base_url();?>assest/images/pop/i_tag.png"/></p>
				</div>

				<div class="col-md-2">
					<a href="" target=""><img src="<?php echo base_url(); ?>assest/images/pop/bighaat.png" style="width:82px; height: 88px;"/><br/><br>
				...
				<div class="col-md-2" style="padding-top: 18px;"><a href="" target=""><img src="<?php echo base_url(); ?>assest/images/pop/agro.png" style="width:100px; height: 70px;" /><br/><br>
			...
			<div align="center" class="row">
				<!-- this agro tech made for laguage change in production 11/10/2023 -->
			<!-- <div class="col-md-2" style="padding-top: 18px;"><a href="" target=""><img src="<?php echo base_url(); ?>assest/images/pop/agro.png" style="width:100px; height: 70px;" /><br/><br>
				<p id="agrotech_pop"><b style="white-space: nowrap;padding-left: 29px"><?php echo $this->lang_file->heading_fetch('agrotech_pop'); ?></b></a><img class="imgpop" data-id="agrotech_pop" src="<?php echo base_url();?>assest/images/pop/i_tag.png"/></p>
				</div>
 -->


			<div class="col-md-2" style="padding-top: 42px;"><a href="" target=""><img src="<?php echo base_url(); ?>assest/images/pop/absolute.png" style="width:94px; height: 49px;" /><br/><br>
