...
<!--<section style="display:none;" class="title-header-bg">
	<div class="text-center">
		<h3><?php //echo $page_title; ?></h3>
<div style="margin-top:12px;" class="text-center"><a href="<?php //echo base_url(); ?>" title="">Home </a> >> <span id="bredcrum"></span></div>
	</div>
</section>-->
 
<div class="container-fuild content-section" style="/*padding-left:4%;padding-right:4%;*/min-height:400px;padding-top:10px;padding-bottom:35px;float:left;width:100%;">
<div class="container">
<div class="col-md-12 bc-nav"><a href="<?php echo base_url(); ?>" title=""><?php echo $this->lang_file->heading_fetch('home');?></a>&nbsp;<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>&nbsp;<span id="bredcrum"></span></div>

	 <?php /* 2 column right =============================*/?>
	 	 <?php if($page_layout == 3){?>
			<div class="row">
			<div class="col-md-9 col-sm-9 content-9">
				<div class="col-md-12 col-sm-12 h-space-padd-r">
				<?php print_r($output);
					 if(isset($page_contents['questions'])){ ?>
						<div class="panel-group" id="accordion">
					<?php foreach($page_contents['questions'] as $key => $question){ ?>
							<div class="panel panel-default">
								...
								<div id="collapse<?php echo $key; ?>" class="panel-collapse collapse <?php if(!$key){ echo "in"; } ?>">
			...
			<div class="col-md-3 col-sm-3 content-3 h-space-padd-l" >
