<section class="title-header-bg">
	<div class="text-center">
		...
		<div style="margin-top:12px;" class="text-center"><a href="<?php echo base_url(); ?>" title=""><img style="margin-top:-6px;" alt="" src="<?php echo base_url(); ?>/assest/images/home-ico.png"></a> <span id="bredcrum"> / <?php echo $this->lang_file->heading_fetch('heading_stories');?> </span></div>
	</div>
</section>
