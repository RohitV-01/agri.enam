...
<div class="container-fuild content-section" style="padding-top:15px;float:left;width:100%;padding-bottom:15px;">
	<div class="container">
		...
		<a href="<?php echo base_url(); ?>success-stories">Success Stories</a>&nbsp;<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>&nbsp;<a href="javascript:void(0)">Process Related Improvement</a></div>
		<div class="col-sm-9 content-9 h-space-padd-r">

			<h3 class="p-title"><span>Process Related Improvement<p class="t-stake-data"></p></span></h3>
			<div class="row">
