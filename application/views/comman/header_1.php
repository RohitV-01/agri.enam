		...
		<div class="col-lg-6 col-sm-6">
			<div class="header-right-section">
				...
				<div class="header-right-list" style="border-right:0px;">
                                        <a href="<?php echo base_url('registration'); ?>" title="Registration"><img alt="Help No" src="<?php echo base_url(); ?>/assest/images/new-theme/registrations.png" />
					<span><b>Registration</b></span></a>
				</div>
				<div class="header-right-list" >
                                        <a class="border" href="<?php echo base_url('login'); ?>" title="Login"><img alt="Help No" src="<?php echo base_url(); ?>/assest/images/new-theme/login-user.png" />
