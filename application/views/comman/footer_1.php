	...
	<div class="container ">
		<div class="row">
			<ul class="footer-site-links list-unstyle list-inline text-center">
				<li><a target="_blank" href="http://www.sfacindia.com/"><img alt="" src="<?php echo base_url(); ?>assest/images/footer/img1.jpg"/></a></li>
				<li><a target="_blank" href="http://india.gov.in/"><img alt="" src="<?php echo base_url(); ?>assest/images/footer/img2.jpg"/></a></li>
				<li><a target="_blank" href="https://digitizeindia.gov.in/"><img alt="" src="<?php echo base_url(); ?>assest/images/footer/img3.jpg"/></a></li>
				<li><a target="_blank" href="http://data.gov.in/"><img alt="" src="<?php echo base_url(); ?>assest/images/footer/img4.jpg"/></a></li>
				<li><a target="_blank" href="http://meity.gov.in/"><img alt="" src="<?php echo base_url(); ?>assest/images/footer/img5.jpg"/></a></li>
				<li><a target="_blank" href="http://pmindia.gov.in/"><img alt="" src="<?php echo base_url(); ?>assest/images/footer/img6.jpg"/></a></li>
				<li><a target="_blank" href="http://www.nagarjunagroup.com/"><img alt="" src="<?php echo base_url(); ?>assest/images/footer/img7.png"/></a></li>
<li><a target="_blank" href="http://digipay.gov.in/dashboard/Default.aspx"><img alt="" src="<?php echo base_url(); ?>assest/images/footer/img8.png"/></a></li>
			</ul>
		</div>
	</div>
	<div class="container">
...
<div class="text-center" style="color: #fff;margin-bottom:5px;">Visitors Count: <span id="visitors_count" >0</span></div>
	</div>
