...
////////////////////admin/////////
// Admin panel routes are DISABLED — login page is turned off.
// To re-enable: uncomment all $route lines below and set
// $config['admin_panel_enabled'] = TRUE in application/config/config.php
