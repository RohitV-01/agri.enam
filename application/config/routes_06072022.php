...
//Feedback Training
//$route['training_feedback'] = 'Feedback_ctrl/feedback';
...
//eNAM vs AGMARKNET price dashboard
$route['dashboard/Agm_Enam_ctrl'] = 'Dashboard_ctrl/eNAM_AGMARKNET';
$route['dashboard/Agm_Enam_ctrl/(:any)/(:any)'] = 'Dashboard_ctrl/eNAM_AGMARKNET/$1/$2';

//Historical price dashboard
$route['dashboard/Historical'] = 'Dashboard_ctrl/historical_trade_data';
$route['dashboard/Historical/(:any)/(:any)'] = 'Dashboard_ctrl/historical_trade_data/$1/$2';
...
$route['admin/admin/enam_blogs'] = 'admin/Blog_ctrl/index';
$route['admin/admin/pop_up'] = 'admin/Pop_up_ctrl/index';
...
$route['blog'] = 'Enam_ctrl/eNam_blogs';

$route['pop-dashboard'] = 'Enam_ctrl/pop_dashboard_home';
$route['pop-dashboard/trading-platforms'] = 'Enam_ctrl/trading_service';
$route['pop-dashboard/trading-platforms/platforms'] = 'Enam_ctrl/platformsIntegrated';
$route['pop-dashboard/trading-platforms/trade-details'] = 'Enam_ctrl/tradeDetails';
$route['pop-dashboard/trading-platforms/advance-demand'] = 'Enam_ctrl/advanceDemand';
$route['pop-dashboard/trading-platforms/advance-supply'] = 'Enam_ctrl/advanceSupply';

$route['pop-dashboard/assaying'] = 'Enam_ctrl/assayingService';
$route['pop-dashboard/assaying/providers'] = 'Enam_ctrl/serviceProviders';
$route['pop-dashboard/transportation'] = 'Enam_ctrl/transportationService';
$route['pop-dashboard/transportation/providers'] = 'Enam_ctrl/transportationProvider';
$route['pop-dashboard/warehousing'] = 'Enam_ctrl/storageFacility';
$route['pop-dashboard/warehousing/providers'] = 'Enam_ctrl/storageFacilityProvider';

$route['pop-dashboard/advisory-services'] = 'Enam_ctrl/advisoryServices';
$route['pop-dashboard/fintech'] = 'Enam_ctrl/financeServices';

$route['pop-dashboard/market-info'] = 'Enam_ctrl/infoDissemination';
$route['pop-dashboard/end-to-end'] = 'Enam_ctrl/endToEnd';
$route['pop-dashboard/institutional-buyer'] =  'Enam_ctrl/endToEnd';
$route['pop-dashboard/shorting-grading'] =  'Enam_ctrl/shortingGrading';
$route['pop-dashboard/wdra'] =  'Enam_ctrl/wdraPage';
$route['pop-dashboard/agri-input'] =  'Enam_ctrl/agriInput';
