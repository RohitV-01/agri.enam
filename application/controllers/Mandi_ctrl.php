...
class Mandi_ctrl extends CI_Controller {
	...
	function online_mandi(){
		$data['page_id'] = 'page_-47';
		$data['title'] = 'eNAM | Mandis Online';
		$data['keywords'] = 'eNAM Mandis Online';
		...
		$data['main_contant'] = $this->load->view('pages/mandi/online_mandi',$data,TRUE);
