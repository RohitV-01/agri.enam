...
class Agm_ctrl extends CI_Controller {
	...
	function menu_activate(){
		...
		if($brea == ""){
			...
			$url_array = ucwords(str_replace("-"," ",$url_array));
			echo json_encode(array('bredcrum'=>$brea,'status'=>500));
		}
...
$max_date = $this->db->get_where('mandi_contact_details',array('status'=>1))->result_array();
        ...
        function commodity_list(){
			...
			if($stateName == "-- All --"){
				...
				$sql = "SELECT mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit , mandi.AGM_Mandi_District_Name ,mmar.Agma_Arrivals, mmpt.Agmp_unit from agm_non_enam_pricetrend_2020jun mmpt
					INNER JOIN agm_non_enam_mandis_2020jun mandi
			        ON(
			             mmpt.Agmp_State = mandi.AGM_Mandi_State_Name
			         and mmpt.Agmp_Non_Enam_Mandi = mandi.AGM_Mandi_Name
			        )
			    INNER JOIN agm_non_enam_arrival_2020jun mmar
				     ON(
				           mmpt.Agmp_State = mmar.Agma_State
				       and mmpt.Agmp_Non_Enam_Mandi = mmar.Agma_Non_Enam_Mandi
				     )
				 WHERE mmpt.Agmp_Arrival_Date >= '".$from_date."' AND mmpt.Agmp_Arrival_Date <= '".$to_date."' GROUP by mmpt.Agmp_Commodity";
			...
			elseif($distName == "-- Select Districts --"){
			    ...
			    INNER JOIN agm_non_enam_arrival_2020jun mmar
				 ...
				 WHERE mmpt.Agmp_State = '".$stateName."' AND mmpt.Agmp_Arrival_Date >= '".$from_date."' AND mmpt.Agmp_Arrival_Date <= '".$to_date."' GROUP by mmpt.Agmp_Commodity";
			...
			elseif($apmcName == "-- Select APMCs --"){
			    ...
			    INNER JOIN agm_non_enam_arrival_2020jun mmar
				 ...
				 WHERE mmpt.Agmp_State = '".$stateName."' AND mandi.AGM_Mandi_District_Name = '".$distName."' AND mmpt.Agmp_Arrival_Date >= '".$from_date."' AND mmpt.Agmp_Arrival_Date <= '".$to_date."' GROUP by mmpt.Agmp_Commodity";
		...
		/*		$sql = "SELECT * from agm_non_enam_pricetrend_2020jun WHERE Agmp_State = ? AND Agmp_Non_Enam_Mandi = ? AND Agmp_Arrival_Date >= ? AND Agmp_Arrival_Date <= ? GROUP by Agmp_Commodity";
			    ...
			    INNER JOIN agm_non_enam_arrival_2020jun mmar
				 ...
				 WHERE mmpt.Agmp_State = '".$stateName."' AND mandi.AGM_Mandi_District_Name = '".$distName."' AND mmpt.Agmp_Non_Enam_Mandi = '".$apmcName."' AND mmpt.Agmp_Arrival_Date >= '".$from_date."' AND mmpt.Agmp_Arrival_Date <= '".$to_date."' GROUP by mmpt.Agmp_Commodity";
...
*//*				$result = $this->db->query("SELECT * from agm_non_enam_pricetrend_2020jun mmpt
				INNER JOIN agm_non_enam_arrival_2020jun mmar
			     ON(
			           mmpt.Agmp_State = mmar.Agma_State
			       and mmpt.Agmp_Non_Enam_Mandi = mmar.Agma_Non_Enam_Mandi
		        ...
		        ON(
				 ...
				 WHERE mmpt.Agmp_Arrival_Date >= '".$from_date."' AND mmpt.Agmp_Arrival_Date <= '".$to_date."' group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit
				 ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC")->result_array();*/
			 ...
			 //    INNER JOIN agm_non_enam_arrival_2020jun mmar
				...
				//        and mmpt.Agmp_Non_Enam_Mandi = mmar.Agma_Non_Enam_Mandi
				//      )
    //       		WHERE mmpt.Agmp_Arrival_Date >= ? AND mmpt.Agmp_Arrival_Date <= ? group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC ";
			    ...
			    INNER JOIN agm_non_enam_arrival_2020jun mmar
         		...
         		WHERE mmpt.Agmp_Arrival_Date >= '".$from_date."' AND mmpt.Agmp_Arrival_Date <= '".$to_date."' group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC";
				$result = $this->db->query($sql)->result_array();
				...
				/*				$result = $this->db->query("select * from agm_non_enam_pricetrend_2020jun mmpt
								...
								WHERE 
								mmpt.Agmp_State = '".$stateName."' AND mandi.AGM_Mandi_District_Name in (SELECT AGM_Mandi_District_Name FROM `agm_non_enam_mandis_2020jun` WHERE AGM_Mandi_State_Name = '".$stateName."' AND AGM_Mandi_Name = '".$apmcName."')
								AND mmpt.Agmp_Arrival_Date >= '".$from_date."' 
								AND mmpt.Agmp_Arrival_Date <= '".$to_date."'
								group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC")->result_array();*/
					$sql = "SELECT * from agm_non_enam_pricetrend_2020jun mmpt
									INNER JOIN agm_non_enam_mandis_2020jun mandi
								        ON(
								             mmpt.Agmp_State = mandi.AGM_Mandi_State_Name
								         and mmpt.Agmp_Non_Enam_Mandi = mandi.AGM_Mandi_Name
								...
								WHERE 
								mmpt.Agmp_State = '".$stateName."' AND mandi.AGM_Mandi_District_Name in (SELECT AGM_Mandi_District_Name FROM `agm_non_enam_mandis_2020jun` WHERE mandi.AGM_Mandi_State_Name = '".$stateName."' AND mandi.AGM_Mandi_Name = '".$apmcName."')
								AND mmpt.Agmp_Arrival_Date >= '".$from_date."' 
								AND mmpt.Agmp_Arrival_Date <= '".$to_date."'
								group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC";
								$result = $this->db->query($sql)->result_array();
...
*/
					$sql = "SELECT * from agm_non_enam_pricetrend_2020jun mmpt
					 ...
					 WHERE mmpt.Agmp_State = '".$stateName."' AND mmpt.Agmp_Arrival_Date >= '".$from_date."' AND mmpt.Agmp_Arrival_Date <= '".$to_date."'
					 group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC";
					$result = $this->db->query($sql)->result_array();
				}
			}
				...
				if(isset($apmcName) && $apmcName != '-- Select APMCs --'){
					/*$result = $this->db->query("select * from trade_data WHERE 
								...
								WHERE 
								mmpt.Agmp_State = '".$stateName."' AND mandi.AGM_Mandi_District_Name in (SELECT AGM_Mandi_District_Name FROM `agm_non_enam_mandis_2020jun` WHERE mandi.AGM_Mandi_State_Name = '".$stateName."' AND mandi.AGM_Mandi_District_Name = '".$districtName."' AND mandi.AGM_Mandi_Name = '".$apmcName."')
								AND mmpt.Agmp_Arrival_Date >= '".$from_date."' 
								AND mmpt.Agmp_Arrival_Date <= '".$to_date."'
								group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC";
								$result = $this->db->query($sql)->result_array();	
				...
				/*	$sql = "SELECT * from trade_data WHERE state = ? AND apmc = ? AND created_at >= ? AND created_at <= ? group by state,apmc,commodity,min_price,modal_price,max_price,commodity_arrivals,commodity_traded,created_at ORDER BY  commodity_traded DESC,state ASC, apmc ASC,created_at DESC";
					...
					$sql = "SELECT * from agm_non_enam_pricetrend_2020jun mmpt
					 ...
					 WHERE mmpt.Agmp_State = '".$stateName."' AND mandi.AGM_Mandi_District_Name = '".$districtName."' 
					 AND mmpt.Agmp_Arrival_Date >= '".$from_date."' 
					 AND mmpt.Agmp_Arrival_Date <= '".$to_date."'
					 group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC";
					$result = $this->db->query($sql)->result_array();
				...
				/*$result = $this->db->query("select * from trade_data WHERE state = '".$stateName."' AND apmc = '".$apmcName."' AND commodity = '".$commodity."' AND created_at >= '".$from_date."' AND created_at <= '".$to_date."' group by state,apmc,commodity,min_price,modal_price,max_price,commodity_arrivals,commodity_traded,created_at ORDER BY commodity_traded DESC,state ASC, apmc ASC,created_at DESC")->result_array();*/
								...
								WHERE 
								mmpt.Agmp_State = '".$stateName."'  AND mandi.AGM_Mandi_District_Name = '".$districtName."' AND 
								mmpt.Agmp_Non_Enam_Mandi = '".$apmcName."' AND mmpt.Agmp_Commodity = '".$commodity."'
								AND mmpt.Agmp_Arrival_Date >= '".$from_date."' 
								AND mmpt.Agmp_Arrival_Date <= '".$to_date."'
								group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC";
								$result = $this->db->query($sql)->result_array();
				...
				/*$result = $this->db->query("select * from trade_data WHERE state = '".$stateName."' AND commodity = '".$commodity."' AND created_at >= '".$from_date."' AND created_at <= '".$to_date."' group by state,apmc,commodity,min_price,modal_price,max_price,commodity_arrivals,commodity_traded,created_at ORDER BY commodity_traded DESC, state ASC, apmc ASC,created_at DESC")->result_array();*/
								...
								WHERE 
								mmpt.Agmp_Commodity = '".$commodity."' AND mmpt.Agmp_State = '".$stateName."'
								AND mmpt.Agmp_Arrival_Date >= '".$from_date."' 
								AND mmpt.Agmp_Arrival_Date <= '".$to_date."'
								group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC";
								$result = $this->db->query($sql)->result_array();
				...
				/*$result = $this->db->query("select * from trade_data WHERE state = '".$stateName."' AND commodity = '".$commodity."' AND created_at >= '".$from_date."' AND created_at <= '".$to_date."' group by state,apmc,commodity,min_price,modal_price,max_price,commodity_arrivals,commodity_traded,created_at ORDER BY commodity_traded DESC, state ASC, apmc ASC,created_at DESC")->result_array();*/
								...
								WHERE 
								mmpt.Agmp_Commodity = '".$commodity."' AND mmpt.Agmp_State = '".$stateName."' AND mandi.AGM_Mandi_District_Name = '".$districtName."'
								AND mmpt.Agmp_Arrival_Date >= '".$from_date."' 
								AND mmpt.Agmp_Arrival_Date <= '".$to_date."'
								group by mmpt.Agmp_State, mmpt.Agmp_Non_Enam_Mandi, mmpt.Agmp_Commodity, mmpt.Agmp_Variety, mmpt.Agmp_Min_Price, mmpt.Agmp_Max_Price, mmpt.Agmp_Modal_Price, mmpt.Agmp_Arrival_Date, mmpt.Agmp_Unit ORDER BY mmpt.Agmp_State ASC, mmpt.Agmp_Non_Enam_Mandi ASC,mmpt.Agmp_Arrival_Date DESC";
								$result = $this->db->query($sql)->result_array();
...
function apmc_data(){
	...
	function stakeholder_default_data(){
		...
		$result = $this->db->query("SELECT sum(trader) as trader,sum(commsionAgent) as commsionAgent, sum(serviceProvider) as serviceProvider,sum(farmer) as farmer, sum(fpo) as fpo  , DATE(created_at) as created_at  FROM `stackholder_data` where created_at = '".$date[0]['created_at']."'")->result_Array();
		if(count($result)>0){
            echo json_encode(array('status'=>200,'data'=>$result));
        }
        else{
