...
//////////////////User Lang Handle/////////////////////////
	$(document).on('click','#upd_lang_file',function(){
          ...
          $(document).on('click','#widget_reset,#video_reset,#slider_reset,#event_reseet,#link_reset,#news_reset,#menu_reset,#u_reg_reset,#users_language_reset,#language_reset,#user_profile_reset,#user_password_reset,#trainning_reset,#story_reset,#ocmmodity_reset,#page_reset',function(){
		location.reload();
	});
